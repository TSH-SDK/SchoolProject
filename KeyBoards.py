...
class Keyboard:
    ...
    def choose_sort():
        ...
        inline_btn_2 = InlineKeyboardButton(text="По рейтингу", callback_data="sort/rate")
        inline_btn_3 = InlineKeyboardButton(text="По возрастанию цены", callback_data="sort/priceup")
        inline_btn_4 = InlineKeyboardButton(text="По убыванию цены", callback_data="sort/pricedown")
    ...
    def delivery_data():
        ...
        inline_btn_2 = InlineKeyboardButton(text="Завтра", callback_data="delivery/24")
        inline_btn_3 = InlineKeyboardButton(text="Послезавтра", callback_data="delivery/48")
        inline_btn_4 = InlineKeyboardButton(text="До 3 дней", callback_data="delivery/72")
        inline_btn_5 = InlineKeyboardButton(text="До 5 дней", callback_data="delivery/120")
